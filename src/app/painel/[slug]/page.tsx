...
export default function PainelBarbeiroSlug() {
  ...
  return (
    <div className="min-h-screen bg-[#0C0C0D] text-white">
      ...
      {/* Modal Calendário com Grade de Horários de 15 minutos */}
      {showCalendar && selectedBarber && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-[#141416] rounded-2xl p-6 w-full max-w-4xl border border-gray-800 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div>
